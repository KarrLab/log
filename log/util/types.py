...
class TypesUtil(object):
    ...
    def assert_value_equal(obj1, obj2, check_type=False, check_iterable_ordering=False):
        ...
        * optionally, element ordering in iterables
        ...
        elif hasattr(obj1, '__iter__') and not (isinstance(obj1, dict) or hasattr(obj1, '__dict__') or isinstance(obj1, six.string_types)):
            if not (hasattr(obj2, '__iter__') and not (isinstance(obj2, dict) or hasattr(obj2, '__dict__') or isinstance(obj2, six.string_types))):
